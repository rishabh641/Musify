...
def create_playlist(sp,songs,uid):
    playlist = sp.user_playlist_create(uid, 'MusifY : Your Top Songs!', description='Your Top Songs of all time!')
...
def serve_image(img):
    ...
    img.save(img_io, 'PNG')
    img_io.seek(0)
    return send_file(img_io, mimetype='image/png', as_attachment=True, attachment_filename='MusifY.png')
